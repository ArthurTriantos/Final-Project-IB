    ...
    <>
      <div className="edit-jumbotron row mb-5 mt-5 jumbotron-fluid">
        <div className="container">
          <h1 className="display-4 text-center jumbo-header">
            Profile
          </h1>
        </div>
      </div>
      <div className="profile col-md-10 border shadow-lg mt-5">
        <div className="row d-flex justify-content-center align-items-center">
          ...
          <div id="hobbies-title row">
            <h2>Hobbies</h2>
          </div>
          <div className="hobbies-container container d-flex justify-content-start flex-wrap">
